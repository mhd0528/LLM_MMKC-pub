...
class KGT5_Model(pl.LightningModule, PyTorchModelHubMixin):
    ...
    def evaluate(self, batch, mode='val'):
        ...
        # print(f"\n>>>> Info for query: {query}\n")
        # print(queries, batch['input'], targets, predictions, true_pos, [len(b) for b in batch['input_ids']])
        ...
        # print(">>>> Answer to query: ", true_answers, true_score)
