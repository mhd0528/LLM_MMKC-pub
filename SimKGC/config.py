...
parser.add_argument('--use_desc', action='store_true', help='Use entity description or not')
...
assert args.task.lower() in ['wn18rr', 'fb15k237', 'wiki5m_ind', 'wiki5m_trans', 'mkg_w', 'mkg_y']
