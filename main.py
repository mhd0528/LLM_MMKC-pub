...
def run(config: DictConfig) -> None:
    ...
    train_options = {
        ...
        # 'limit_val_batches': config.valid.limit_batches,
    }
    if not config.valid.tiny:  # if not tiny, limit batches
        train_options["limit_val_batches"] = config.valid.limit_batches
    if config.wandb.use:
